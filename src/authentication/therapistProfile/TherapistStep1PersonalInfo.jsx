    ...
    <div className="text-gray-900">
      ...
      <div className="mb-4">
        ...
        <div
          ...
          onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') document.getElementById('videoIntroduction').click(); }}
          role="button"
          tabIndex={0}
        ...
        >
          ...
          <p className="text-gray-600 mb-1 text-sm">Click to upload files or drag and drop</p>
        ...
        <input
          ...
          className="hidden"
        />
        <ErrorMessage name="videoIntroduction" component="div" className="text-red-500 text-sm" />
      </div>
    </div>
  );
};
